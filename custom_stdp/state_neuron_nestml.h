...
namespace state_neuron_nestml_names
{
    ...
    const std::string _current_fbk_input( "current_fbk_input" );
    const std::string _current_pred_input( "current_pred_input" );
    const std::string _fbk_buffer( "fbk_buffer" );
    const std::string _pred_buffer( "pred_buffer" );
    const std::string _fbk_counts( "fbk_counts" );
    const std::string _pred_counts( "pred_counts" );
    const std::string _tick( "tick" );
    const std::string _position_count( "position_count" );
    const std::string _mean_fbk( "mean_fbk" );
    const std::string _mean_pred( "mean_pred" );
    const std::string _var_fbk( "var_fbk" );
    const std::string _var_pred( "var_pred" );
    const std::string _CV_fbk( "CV_fbk" );
    const std::string _CV_pred( "CV_pred" );
    const std::string _total_CV( "total_CV" );
    ...
    const std::string _N_fbk( "N_fbk" );
    const std::string _N_pred( "N_pred" );
    const std::string _fbk_bf_size( "fbk_bf_size" );
    const std::string _pred_bf_size( "pred_bf_size" );
    const std::string _time_wait( "time_wait" );
    const std::string _time_trial( "time_trial" );
}
}
...
inline void state_neuron_nestml::get_status(Dictionary &__d) const
{
  // parameters
  __d[ nest::state_neuron_nestml_names::_kp ] = get_kp();
  __d[ nest::state_neuron_nestml_names::_pos ] = get_pos();
  __d[ nest::state_neuron_nestml_names::_base_rate ] = get_base_rate();
  __d[ nest::state_neuron_nestml_names::_buffer_size ] = get_buffer_size();
  __d[ nest::state_neuron_nestml_names::_simulation_steps ] = get_simulation_steps();
  __d[ nest::state_neuron_nestml_names::_N_fbk ] = get_N_fbk();
  __d[ nest::state_neuron_nestml_names::_N_pred ] = get_N_pred();
  __d[ nest::state_neuron_nestml_names::_fbk_bf_size ] = get_fbk_bf_size();
  __d[ nest::state_neuron_nestml_names::_pred_bf_size ] = get_pred_bf_size();
  __d[ nest::state_neuron_nestml_names::_time_wait ] = get_time_wait();
  __d[ nest::state_neuron_nestml_names::_time_trial ] = get_time_trial();

  // initial values for state variables in ODE or kernel
  __d[ nest::state_neuron_nestml_names::_in_rate ] = get_in_rate();
  __d[ nest::state_neuron_nestml_names::_out_rate ] = get_out_rate();
  __d[ nest::state_neuron_nestml_names::_spike_count_out ] = get_spike_count_out();
  __d[ nest::state_neuron_nestml_names::_current_fbk_input ] = get_current_fbk_input();
  __d[ nest::state_neuron_nestml_names::_current_pred_input ] = get_current_pred_input();
  __d[ nest::state_neuron_nestml_names::_fbk_buffer ] = get_fbk_buffer();
  __d[ nest::state_neuron_nestml_names::_pred_buffer ] = get_pred_buffer();
  __d[ nest::state_neuron_nestml_names::_fbk_counts ] = get_fbk_counts();
  __d[ nest::state_neuron_nestml_names::_pred_counts ] = get_pred_counts();
  __d[ nest::state_neuron_nestml_names::_tick ] = get_tick();
  __d[ nest::state_neuron_nestml_names::_position_count ] = get_position_count();
  __d[ nest::state_neuron_nestml_names::_mean_fbk ] = get_mean_fbk();
  __d[ nest::state_neuron_nestml_names::_mean_pred ] = get_mean_pred();
  __d[ nest::state_neuron_nestml_names::_var_fbk ] = get_var_fbk();
  __d[ nest::state_neuron_nestml_names::_var_pred ] = get_var_pred();
  __d[ nest::state_neuron_nestml_names::_CV_fbk ] = get_CV_fbk();
  __d[ nest::state_neuron_nestml_names::_CV_pred ] = get_CV_pred();
  __d[ nest::state_neuron_nestml_names::_total_CV ] = get_total_CV();
  __d[ nest::state_neuron_nestml_names::_lambda_poisson ] = get_lambda_poisson();
...
inline void state_neuron_nestml::set_status(const Dictionary &__d)
{
  // parameters
  double tmp_kp = get_kp();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_kp, tmp_kp, this);
  // Resize vectors
  if (tmp_kp != get_kp())
  {
  }
  bool tmp_pos = get_pos();
  nest::update_value_param<bool>(__d, nest::state_neuron_nestml_names::_pos, tmp_pos, this);
  // Resize vectors
  if (tmp_pos != get_pos())
  {
  }
  double tmp_base_rate = get_base_rate();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_base_rate, tmp_base_rate, this);
  // Resize vectors
  if (tmp_base_rate != get_base_rate())
  {
  }
  double tmp_buffer_size = get_buffer_size();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_buffer_size, tmp_buffer_size, this);
  // Resize vectors
  if (tmp_buffer_size != get_buffer_size())
  {
  }
  long tmp_simulation_steps = get_simulation_steps();
  nest::update_value_param<long>(__d, nest::state_neuron_nestml_names::_simulation_steps, tmp_simulation_steps, this);
  // Resize vectors
  if (tmp_simulation_steps != get_simulation_steps())
  {
  }
  long tmp_N_fbk = get_N_fbk();
  nest::update_value_param<long>(__d, nest::state_neuron_nestml_names::_N_fbk, tmp_N_fbk, this);
  // Resize vectors
  ...
  nest::update_value_param<long>(__d, nest::state_neuron_nestml_names::_N_pred, tmp_N_pred, this);
  // Resize vectors
  ...
  nest::update_value_param<long>(__d, nest::state_neuron_nestml_names::_fbk_bf_size, tmp_fbk_bf_size, this);
  // Resize vectors
  ...
  nest::update_value_param<long>(__d, nest::state_neuron_nestml_names::_pred_bf_size, tmp_pred_bf_size, this);
  // Resize vectors
  ...
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_time_wait, tmp_time_wait, this);
  // Resize vectors
  if (tmp_time_wait != get_time_wait())
  {
  }
  double tmp_time_trial = get_time_trial();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_time_trial, tmp_time_trial, this);
  // Resize vectors
  ...
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_in_rate, tmp_in_rate, this);
  double tmp_out_rate = get_out_rate();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_out_rate, tmp_out_rate, this);
  long tmp_spike_count_out = get_spike_count_out();
  nest::update_value_param<long>(__d, nest::state_neuron_nestml_names::_spike_count_out, tmp_spike_count_out, this);
  std::vector< double >  tmp_current_fbk_input = get_current_fbk_input();
  __d.update_value( nest::state_neuron_nestml_names::_current_fbk_input, tmp_current_fbk_input);
  ...
  __d.update_value( nest::state_neuron_nestml_names::_current_pred_input, tmp_current_pred_input);
  ...
  __d.update_value( nest::state_neuron_nestml_names::_fbk_buffer, tmp_fbk_buffer);
  ...
  __d.update_value( nest::state_neuron_nestml_names::_pred_buffer, tmp_pred_buffer);
  ...
  __d.update_value( nest::state_neuron_nestml_names::_fbk_counts, tmp_fbk_counts);
  ...
  __d.update_value( nest::state_neuron_nestml_names::_pred_counts, tmp_pred_counts);
  ...
  nest::update_value_param<long>(__d, nest::state_neuron_nestml_names::_tick, tmp_tick, this);
  long tmp_position_count = get_position_count();
  nest::update_value_param<long>(__d, nest::state_neuron_nestml_names::_position_count, tmp_position_count, this);
  double tmp_mean_fbk = get_mean_fbk();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_mean_fbk, tmp_mean_fbk, this);
  double tmp_mean_pred = get_mean_pred();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_mean_pred, tmp_mean_pred, this);
  double tmp_var_fbk = get_var_fbk();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_var_fbk, tmp_var_fbk, this);
  double tmp_var_pred = get_var_pred();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_var_pred, tmp_var_pred, this);
  double tmp_CV_fbk = get_CV_fbk();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_CV_fbk, tmp_CV_fbk, this);
  double tmp_CV_pred = get_CV_pred();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_CV_pred, tmp_CV_pred, this);
  double tmp_total_CV = get_total_CV();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_total_CV, tmp_total_CV, this);
  double tmp_lambda_poisson = get_lambda_poisson();
  nest::update_value_param<double>(__d, nest::state_neuron_nestml_names::_lambda_poisson, tmp_lambda_poisson, this);
