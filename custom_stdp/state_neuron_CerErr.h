...
**/
#ifndef STATE_NEURON_CERERR
#define STATE_NEURON_CERERR
...
namespace nest
{
namespace state_neuron_CerErr_names
{
    ...
    const Name _w_fbk_raw( "w_fbk_raw" );
    const Name _w_pred_raw( "w_pred_raw" );
...
void register_state_neuron_CerErr( const std::string& name );

class state_neuron_CerErr : public nest::ArchivingNode
{
public:
  /**
  ...
  **/
  state_neuron_CerErr(const state_neuron_CerErr &);

  /**
   * Destructor.
  **/
  ~state_neuron_CerErr() override;
  ...
  **/
  ...
  inline double get_w_fbk_raw() const
  {
    return S_.w_fbk_raw;
  }

  inline void set_w_fbk_raw(const double __v)
  {
    S_.w_fbk_raw = __v;
  }

  inline double get_w_pred_raw() const
  {
    return S_.w_pred_raw;
  }

  inline void set_w_pred_raw(const double __v)
  {
    S_.w_pred_raw = __v;
  }
  ...
  inline void set_p(const double __v)
  {
    P_.p = __v;
  }
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::DynamicRecordablesMap< state_neuron_CerErr >;
  friend class nest::DynamicUniversalDataLogger< state_neuron_CerErr >;
  friend class nest::DataAccessFunctor< state_neuron_CerErr >;
...
enum StateVecVars {
  ...
  **/
  struct Buffers_
  {
    Buffers_(state_neuron_CerErr &);
    Buffers_(const Buffers_ &, state_neuron_CerErr &);

    /**
     * Logger for all analog data
    **/
    nest::DynamicUniversalDataLogger<state_neuron_CerErr> logger_;
  ...
  **/
  ...
  nest::DynamicRecordablesMap<state_neuron_CerErr> recordablesMap_;
  nest::DataAccessFunctor< state_neuron_CerErr > get_data_access_functor( size_t elem );
...
P_.error_bf_size)
    ...
    (elem == State_::W_FBK_RAW)
    {
      return S_.w_fbk_raw;
    }
    else if
    (elem == State_::W_PRED_RAW)
    {
      return S_.w_pred_raw;
    }
    else if
...
}; /* neuron state_neuron_CerErr */

inline nest_port_t state_neuron_CerErr::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t state_neuron_CerErr::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
...
inline nest_port_t state_neuron_CerErr::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
...
inline void state_neuron_CerErr::get_status(DictionaryDatum &__d) const
{
  // parameters
  def< double >(__d, nest::state_neuron_CerErr_names::_kp, get_kp());
  def< bool >(__d, nest::state_neuron_CerErr_names::_pos, get_pos());
  def< double >(__d, nest::state_neuron_CerErr_names::_base_rate, get_base_rate());
  def< double >(__d, nest::state_neuron_CerErr_names::_buffer_size, get_buffer_size());
  def< double >(__d, nest::state_neuron_CerErr_names::_buffer_size_error, get_buffer_size_error());
  def< long >(__d, nest::state_neuron_CerErr_names::_simulation_steps, get_simulation_steps());
  def< long >(__d, nest::state_neuron_CerErr_names::_N_fbk, get_N_fbk());
  def< long >(__d, nest::state_neuron_CerErr_names::_N_pred, get_N_pred());
  def< long >(__d, nest::state_neuron_CerErr_names::_N_error, get_N_error());
  def< double >(__d, nest::state_neuron_CerErr_names::_C_error, get_C_error());
  def< double >(__d, nest::state_neuron_CerErr_names::_p, get_p());
  def< double >(__d, nest::state_neuron_CerErr_names::_alpha, get_alpha());
  def< long >(__d, nest::state_neuron_CerErr_names::_fbk_bf_size, get_fbk_bf_size());
  def< long >(__d, nest::state_neuron_CerErr_names::_pred_bf_size, get_pred_bf_size());
  def< long >(__d, nest::state_neuron_CerErr_names::_error_bf_size, get_error_bf_size());
  def< double >(__d, nest::state_neuron_CerErr_names::_time_wait, get_time_wait());
  def< double >(__d, nest::state_neuron_CerErr_names::_time_trial, get_time_trial());

  // initial values for state variables in ODE or kernel
  def< double >(__d, nest::state_neuron_CerErr_names::_in_rate, get_in_rate());
  def< double >(__d, nest::state_neuron_CerErr_names::_out_rate, get_out_rate());
  def< long >(__d, nest::state_neuron_CerErr_names::_spike_count_out, get_spike_count_out());
  def< std::vector< double >  >(__d, nest::state_neuron_CerErr_names::_current_fbk_input, get_current_fbk_input());
  def< std::vector< double >  >(__d, nest::state_neuron_CerErr_names::_current_pred_input, get_current_pred_input());
  def< std::vector< double >  >(__d, nest::state_neuron_CerErr_names::_fbk_buffer, get_fbk_buffer());
  def< std::vector< double >  >(__d, nest::state_neuron_CerErr_names::_pred_buffer, get_pred_buffer());
  def< std::vector< double >  >(__d, nest::state_neuron_CerErr_names::_fbk_counts, get_fbk_counts());
  def< std::vector< double >  >(__d, nest::state_neuron_CerErr_names::_pred_counts, get_pred_counts());
  def< long >(__d, nest::state_neuron_CerErr_names::_tick, get_tick());
  def< long >(__d, nest::state_neuron_CerErr_names::_position_count, get_position_count());
  def< double >(__d, nest::state_neuron_CerErr_names::_mean_fbk, get_mean_fbk());
  def< double >(__d, nest::state_neuron_CerErr_names::_mean_pred, get_mean_pred());
  def< double >(__d, nest::state_neuron_CerErr_names::_var_fbk, get_var_fbk());
  def< double >(__d, nest::state_neuron_CerErr_names::_var_pred, get_var_pred());
  def< double >(__d, nest::state_neuron_CerErr_names::_CV_fbk, get_CV_fbk());
  def< double >(__d, nest::state_neuron_CerErr_names::_CV_pred, get_CV_pred());
  def< double >(__d, nest::state_neuron_CerErr_names::_current_error_input, get_current_error_input());
  def< std::vector< double >  >(__d, nest::state_neuron_CerErr_names::_error_buffer, get_error_buffer());
  def< long >(__d, nest::state_neuron_CerErr_names::_err_pos_count, get_err_pos_count());
  def< double >(__d, nest::state_neuron_CerErr_names::_error_counts, get_error_counts());
  def< double >(__d, nest::state_neuron_CerErr_names::_error_rate, get_error_rate());
  def< double >(__d, nest::state_neuron_CerErr_names::_fbk_rate, get_fbk_rate());
  def< double >(__d, nest::state_neuron_CerErr_names::_w_fbk, get_w_fbk());
  def< double >(__d, nest::state_neuron_CerErr_names::_w_pred, get_w_pred());
  def< double >(__d, nest::state_neuron_CerErr_names::_w_fbk_raw, get_w_fbk_raw());
  def< double >(__d, nest::state_neuron_CerErr_names::_w_pred_raw, get_w_pred_raw());
  def< double >(__d, nest::state_neuron_CerErr_names::_total_CV, get_total_CV());
  def< double >(__d, nest::state_neuron_CerErr_names::_lambda_poisson, get_lambda_poisson());
...
inline void state_neuron_CerErr::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_kp = get_kp();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_kp, tmp_kp, this);
  // Resize vectors
  if (tmp_kp != get_kp())
  {
  }
  bool tmp_pos = get_pos();
  nest::updateValueParam<bool>(__d, nest::state_neuron_CerErr_names::_pos, tmp_pos, this);
  // Resize vectors
  if (tmp_pos != get_pos())
  {
  }
  double tmp_base_rate = get_base_rate();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_base_rate, tmp_base_rate, this);
  // Resize vectors
  if (tmp_base_rate != get_base_rate())
  {
  }
  double tmp_buffer_size = get_buffer_size();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_buffer_size, tmp_buffer_size, this);
  // Resize vectors
  if (tmp_buffer_size != get_buffer_size())
  {
  }
  double tmp_buffer_size_error = get_buffer_size_error();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_buffer_size_error, tmp_buffer_size_error, this);
  // Resize vectors
  if (tmp_buffer_size_error != get_buffer_size_error())
  {
  }
  long tmp_simulation_steps = get_simulation_steps();
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_simulation_steps, tmp_simulation_steps, this);
  // Resize vectors
  if (tmp_simulation_steps != get_simulation_steps())
  {
  }
  long tmp_N_fbk = get_N_fbk();
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_N_fbk, tmp_N_fbk, this);
  // Resize vectors
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_N_pred, tmp_N_pred, this);
  // Resize vectors
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_N_error, tmp_N_error, this);
  // Resize vectors
  if (tmp_N_error != get_N_error())
  {
  }
  double tmp_C_error = get_C_error();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_C_error, tmp_C_error, this);
  // Resize vectors
  if (tmp_C_error != get_C_error())
  {
  }
  double tmp_p = get_p();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_p, tmp_p, this);
  // Resize vectors
  if (tmp_p != get_p())
  {
  }
  double tmp_alpha = get_alpha();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_alpha, tmp_alpha, this);
  // Resize vectors
  if (tmp_alpha != get_alpha())
  {
  }
  long tmp_fbk_bf_size = get_fbk_bf_size();
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_fbk_bf_size, tmp_fbk_bf_size, this);
  // Resize vectors
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_pred_bf_size, tmp_pred_bf_size, this);
  // Resize vectors
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_error_bf_size, tmp_error_bf_size, this);
  // Resize vectors
  ...
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_time_wait, tmp_time_wait, this);
  // Resize vectors
  if (tmp_time_wait != get_time_wait())
  {
  }
  double tmp_time_trial = get_time_trial();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_time_trial, tmp_time_trial, this);
  // Resize vectors
  ...
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_in_rate, tmp_in_rate, this);
  double tmp_out_rate = get_out_rate();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_out_rate, tmp_out_rate, this);
  long tmp_spike_count_out = get_spike_count_out();
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_spike_count_out, tmp_spike_count_out, this);
  std::vector< double >  tmp_current_fbk_input = get_current_fbk_input();
  updateValue<std::vector< double > >(__d, nest::state_neuron_CerErr_names::_current_fbk_input, tmp_current_fbk_input);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CerErr_names::_current_pred_input, tmp_current_pred_input);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CerErr_names::_fbk_buffer, tmp_fbk_buffer);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CerErr_names::_pred_buffer, tmp_pred_buffer);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CerErr_names::_fbk_counts, tmp_fbk_counts);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CerErr_names::_pred_counts, tmp_pred_counts);
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_tick, tmp_tick, this);
  long tmp_position_count = get_position_count();
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_position_count, tmp_position_count, this);
  double tmp_mean_fbk = get_mean_fbk();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_mean_fbk, tmp_mean_fbk, this);
  double tmp_mean_pred = get_mean_pred();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_mean_pred, tmp_mean_pred, this);
  double tmp_var_fbk = get_var_fbk();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_var_fbk, tmp_var_fbk, this);
  double tmp_var_pred = get_var_pred();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_var_pred, tmp_var_pred, this);
  double tmp_CV_fbk = get_CV_fbk();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_CV_fbk, tmp_CV_fbk, this);
  double tmp_CV_pred = get_CV_pred();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_CV_pred, tmp_CV_pred, this);
  double tmp_current_error_input = get_current_error_input();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_current_error_input, tmp_current_error_input, this);
  std::vector< double >  tmp_error_buffer = get_error_buffer();
  updateValue<std::vector< double > >(__d, nest::state_neuron_CerErr_names::_error_buffer, tmp_error_buffer);
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CerErr_names::_err_pos_count, tmp_err_pos_count, this);
  double tmp_error_counts = get_error_counts();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_error_counts, tmp_error_counts, this);
  double tmp_error_rate = get_error_rate();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_error_rate, tmp_error_rate, this);
  double tmp_fbk_rate = get_fbk_rate();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_fbk_rate, tmp_fbk_rate, this);
  double tmp_w_fbk = get_w_fbk();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_w_fbk, tmp_w_fbk, this);
  double tmp_w_pred = get_w_pred();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_w_pred, tmp_w_pred, this);
  double tmp_w_fbk_raw = get_w_fbk_raw();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_w_fbk_raw, tmp_w_fbk_raw, this);
  double tmp_w_pred_raw = get_w_pred_raw();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_w_pred_raw, tmp_w_pred_raw, this);
  double tmp_total_CV = get_total_CV();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_total_CV, tmp_total_CV, this);
  double tmp_lambda_poisson = get_lambda_poisson();
  nest::updateValueParam<double>(__d, nest::state_neuron_CerErr_names::_lambda_poisson, tmp_lambda_poisson, this);
  ...
  set_w_fbk_raw(tmp_w_fbk_raw);
  set_w_pred_raw(tmp_w_pred_raw);
...
#endif /* #ifndef STATE_NEURON_CERERR */
