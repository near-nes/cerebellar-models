...
inline void eglif_io_nestml::get_status(Dictionary &__d) const
{
  // parameters
  __d[ eglif_io_nestml_names::_C_m ] = get_C_m();
  __d[ eglif_io_nestml_names::_tau_m ] = get_tau_m();
  __d[ eglif_io_nestml_names::_E_L ] = get_E_L();
  __d[ eglif_io_nestml_names::_t_ref ] = get_t_ref();
  __d[ eglif_io_nestml_names::_V_reset ] = get_V_reset();
  __d[ eglif_io_nestml_names::_V_th ] = get_V_th();
  __d[ eglif_io_nestml_names::_offset ] = get_offset();
  __d[ eglif_io_nestml_names::_Vmin ] = get_Vmin();
  __d[ eglif_io_nestml_names::_I_e ] = get_I_e();
  __d[ eglif_io_nestml_names::_Vinit ] = get_Vinit();
  __d[ eglif_io_nestml_names::_lambda_0 ] = get_lambda_0();
  __d[ eglif_io_nestml_names::_tau_V ] = get_tau_V();
  __d[ eglif_io_nestml_names::_kadap ] = get_kadap();
  __d[ eglif_io_nestml_names::_k2 ] = get_k2();
  __d[ eglif_io_nestml_names::_k1 ] = get_k1();
  __d[ eglif_io_nestml_names::_A1 ] = get_A1();
  __d[ eglif_io_nestml_names::_A2 ] = get_A2();
  __d[ eglif_io_nestml_names::_E_rev1 ] = get_E_rev1();
  __d[ eglif_io_nestml_names::_E_rev2 ] = get_E_rev2();
  __d[ eglif_io_nestml_names::_E_rev3 ] = get_E_rev3();
  __d[ eglif_io_nestml_names::_E_rev4 ] = get_E_rev4();
  __d[ eglif_io_nestml_names::_tau_syn1 ] = get_tau_syn1();
  __d[ eglif_io_nestml_names::_tau_syn2 ] = get_tau_syn2();
  __d[ eglif_io_nestml_names::_tau_syn3 ] = get_tau_syn3();
  __d[ eglif_io_nestml_names::_tau_syn4 ] = get_tau_syn4();

  // initial values for state variables in ODE or kernel
  __d[ eglif_io_nestml_names::_V_m ] = get_V_m();
  __d[ eglif_io_nestml_names::_I_adap ] = get_I_adap();
  __d[ eglif_io_nestml_names::_I_dep ] = get_I_dep();
  __d[ eglif_io_nestml_names::_r ] = get_r();
  __d[ eglif_io_nestml_names::_lambda ] = get_lambda();
  __d[ eglif_io_nestml_names::_cf_buffer ] = get_cf_buffer();
  __d[ eglif_io_nestml_names::_tick ] = get_tick();
  __d[ eglif_io_nestml_names::_current_step ] = get_current_step();
  __d[ eglif_io_nestml_names::_g3__X__rec3 ] = get_g3__X__rec3();
  __d[ eglif_io_nestml_names::_g3__X__rec3__d ] = get_g3__X__rec3__d();
  __d[ eglif_io_nestml_names::_g2__X__rec2 ] = get_g2__X__rec2();
  __d[ eglif_io_nestml_names::_g2__X__rec2__d ] = get_g2__X__rec2__d();
  __d[ eglif_io_nestml_names::_g4__X__rec4 ] = get_g4__X__rec4();
  __d[ eglif_io_nestml_names::_g4__X__rec4__d ] = get_g4__X__rec4__d();
  __d[ eglif_io_nestml_names::_g1__X__rec1 ] = get_g1__X__rec1();
  __d[ eglif_io_nestml_names::_g1__X__rec1__d ] = get_g1__X__rec1__d();
...
inline void eglif_io_nestml::set_status(const Dictionary &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_C_m, tmp_C_m, this);
  double tmp_tau_m = get_tau_m();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_tau_m, tmp_tau_m, this);
  double tmp_E_L = get_E_L();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_E_L, tmp_E_L, this);
  double tmp_t_ref = get_t_ref();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_t_ref, tmp_t_ref, this);
  double tmp_V_reset = get_V_reset();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_V_reset, tmp_V_reset, this);
  double tmp_V_th = get_V_th();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_V_th, tmp_V_th, this);
  double tmp_offset = get_offset();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_offset, tmp_offset, this);
  double tmp_Vmin = get_Vmin();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_Vmin, tmp_Vmin, this);
  double tmp_I_e = get_I_e();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_I_e, tmp_I_e, this);
  double tmp_Vinit = get_Vinit();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_Vinit, tmp_Vinit, this);
  double tmp_lambda_0 = get_lambda_0();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_lambda_0, tmp_lambda_0, this);
  double tmp_tau_V = get_tau_V();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_tau_V, tmp_tau_V, this);
  double tmp_kadap = get_kadap();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_kadap, tmp_kadap, this);
  double tmp_k2 = get_k2();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_k2, tmp_k2, this);
  double tmp_k1 = get_k1();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_k1, tmp_k1, this);
  double tmp_A1 = get_A1();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_A1, tmp_A1, this);
  double tmp_A2 = get_A2();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_A2, tmp_A2, this);
  double tmp_E_rev1 = get_E_rev1();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_E_rev1, tmp_E_rev1, this);
  double tmp_E_rev2 = get_E_rev2();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_E_rev2, tmp_E_rev2, this);
  double tmp_E_rev3 = get_E_rev3();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_E_rev3, tmp_E_rev3, this);
  double tmp_E_rev4 = get_E_rev4();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_E_rev4, tmp_E_rev4, this);
  double tmp_tau_syn1 = get_tau_syn1();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_tau_syn1, tmp_tau_syn1, this);
  double tmp_tau_syn2 = get_tau_syn2();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_tau_syn2, tmp_tau_syn2, this);
  double tmp_tau_syn3 = get_tau_syn3();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_tau_syn3, tmp_tau_syn3, this);
  double tmp_tau_syn4 = get_tau_syn4();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_tau_syn4, tmp_tau_syn4, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_V_m, tmp_V_m, this);
  double tmp_I_adap = get_I_adap();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_I_adap, tmp_I_adap, this);
  double tmp_I_dep = get_I_dep();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_I_dep, tmp_I_dep, this);
  long tmp_r = get_r();
  nest::update_value_param<long>(__d, eglif_io_nestml_names::_r, tmp_r, this);
  double tmp_lambda = get_lambda();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_lambda, tmp_lambda, this);
  double tmp_cf_buffer = get_cf_buffer();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_cf_buffer, tmp_cf_buffer, this);
  double tmp_tick = get_tick();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_tick, tmp_tick, this);
  long tmp_current_step = get_current_step();
  nest::update_value_param<long>(__d, eglif_io_nestml_names::_current_step, tmp_current_step, this);
  double tmp_g3__X__rec3 = get_g3__X__rec3();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_g3__X__rec3, tmp_g3__X__rec3, this);
  double tmp_g3__X__rec3__d = get_g3__X__rec3__d();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_g3__X__rec3__d, tmp_g3__X__rec3__d, this);
  double tmp_g2__X__rec2 = get_g2__X__rec2();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_g2__X__rec2, tmp_g2__X__rec2, this);
  double tmp_g2__X__rec2__d = get_g2__X__rec2__d();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_g2__X__rec2__d, tmp_g2__X__rec2__d, this);
  double tmp_g4__X__rec4 = get_g4__X__rec4();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_g4__X__rec4, tmp_g4__X__rec4, this);
  double tmp_g4__X__rec4__d = get_g4__X__rec4__d();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_g4__X__rec4__d, tmp_g4__X__rec4__d, this);
  double tmp_g1__X__rec1 = get_g1__X__rec1();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_g1__X__rec1, tmp_g1__X__rec1, this);
  double tmp_g1__X__rec1__d = get_g1__X__rec1__d();
  nest::update_value_param<double>(__d, eglif_io_nestml_names::_g1__X__rec1__d, tmp_g1__X__rec1__d, this);
