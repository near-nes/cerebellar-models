...
**/
#ifndef STATE_NEURON_CV
#define STATE_NEURON_CV
...
namespace nest
{
namespace state_neuron_CV_names
{
    ...
    const Name _p( "p" );
    const Name _pred_offset( "pred_offset" );
...
void register_state_neuron_CV( const std::string& name );

class state_neuron_CV : public nest::ArchivingNode
{
public:
  /**
  ...
  **/
  state_neuron_CV(const state_neuron_CV &);

  /**
   * Destructor.
  **/
  ~state_neuron_CV() override;
  ...
  **/
  ...
  inline double get_pred_offset() const
  {
    return P_.pred_offset;
  }

  inline void set_pred_offset(const double __v)
  {
    P_.pred_offset = __v;
  }
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::DynamicRecordablesMap< state_neuron_CV >;
  friend class nest::DynamicUniversalDataLogger< state_neuron_CV >;
  friend class nest::DataAccessFunctor< state_neuron_CV >;
...
enum StateVecVars {
  ...
  **/
  struct Buffers_
  {
    Buffers_(state_neuron_CV &);
    Buffers_(const Buffers_ &, state_neuron_CV &);

    /**
     * Logger for all analog data
    **/
    nest::DynamicUniversalDataLogger<state_neuron_CV> logger_;
  ...
  **/
  ...
  nest::DynamicRecordablesMap<state_neuron_CV> recordablesMap_;
  nest::DataAccessFunctor< state_neuron_CV > get_data_access_functor( size_t elem );
...
}; /* neuron state_neuron_CV */

inline nest_port_t state_neuron_CV::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t state_neuron_CV::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
...
inline nest_port_t state_neuron_CV::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
...
inline void state_neuron_CV::get_status(DictionaryDatum &__d) const
{
  // parameters
  def< double >(__d, nest::state_neuron_CV_names::_kp, get_kp());
  def< bool >(__d, nest::state_neuron_CV_names::_pos, get_pos());
  def< double >(__d, nest::state_neuron_CV_names::_base_rate, get_base_rate());
  def< double >(__d, nest::state_neuron_CV_names::_buffer_size, get_buffer_size());
  def< long >(__d, nest::state_neuron_CV_names::_simulation_steps, get_simulation_steps());
  def< long >(__d, nest::state_neuron_CV_names::_N_fbk, get_N_fbk());
  def< long >(__d, nest::state_neuron_CV_names::_N_pred, get_N_pred());
  def< long >(__d, nest::state_neuron_CV_names::_fbk_bf_size, get_fbk_bf_size());
  def< long >(__d, nest::state_neuron_CV_names::_pred_bf_size, get_pred_bf_size());
  def< double >(__d, nest::state_neuron_CV_names::_p, get_p());
  def< double >(__d, nest::state_neuron_CV_names::_pred_offset, get_pred_offset());
  def< double >(__d, nest::state_neuron_CV_names::_time_wait, get_time_wait());
  def< double >(__d, nest::state_neuron_CV_names::_time_trial, get_time_trial());

  // initial values for state variables in ODE or kernel
  def< double >(__d, nest::state_neuron_CV_names::_in_rate, get_in_rate());
  def< double >(__d, nest::state_neuron_CV_names::_out_rate, get_out_rate());
  def< long >(__d, nest::state_neuron_CV_names::_spike_count_out, get_spike_count_out());
  def< std::vector< double >  >(__d, nest::state_neuron_CV_names::_current_fbk_input, get_current_fbk_input());
  def< std::vector< double >  >(__d, nest::state_neuron_CV_names::_current_pred_input, get_current_pred_input());
  def< std::vector< double >  >(__d, nest::state_neuron_CV_names::_fbk_buffer, get_fbk_buffer());
  def< std::vector< double >  >(__d, nest::state_neuron_CV_names::_pred_buffer, get_pred_buffer());
  def< std::vector< double >  >(__d, nest::state_neuron_CV_names::_fbk_counts, get_fbk_counts());
  def< std::vector< double >  >(__d, nest::state_neuron_CV_names::_pred_counts, get_pred_counts());
  def< long >(__d, nest::state_neuron_CV_names::_tick, get_tick());
  def< long >(__d, nest::state_neuron_CV_names::_position_count, get_position_count());
  def< double >(__d, nest::state_neuron_CV_names::_mean_fbk, get_mean_fbk());
  def< double >(__d, nest::state_neuron_CV_names::_mean_pred, get_mean_pred());
  def< double >(__d, nest::state_neuron_CV_names::_var_fbk, get_var_fbk());
  def< double >(__d, nest::state_neuron_CV_names::_var_pred, get_var_pred());
  def< double >(__d, nest::state_neuron_CV_names::_CV_fbk, get_CV_fbk());
  def< double >(__d, nest::state_neuron_CV_names::_CV_pred, get_CV_pred());
  def< double >(__d, nest::state_neuron_CV_names::_w_fbk, get_w_fbk());
  def< double >(__d, nest::state_neuron_CV_names::_w_pred, get_w_pred());
  def< double >(__d, nest::state_neuron_CV_names::_total_CV, get_total_CV());
  def< double >(__d, nest::state_neuron_CV_names::_lambda_poisson, get_lambda_poisson());
...
inline void state_neuron_CV::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_kp = get_kp();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_kp, tmp_kp, this);
  // Resize vectors
  if (tmp_kp != get_kp())
  {
  }
  bool tmp_pos = get_pos();
  nest::updateValueParam<bool>(__d, nest::state_neuron_CV_names::_pos, tmp_pos, this);
  // Resize vectors
  if (tmp_pos != get_pos())
  {
  }
  double tmp_base_rate = get_base_rate();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_base_rate, tmp_base_rate, this);
  // Resize vectors
  if (tmp_base_rate != get_base_rate())
  {
  }
  double tmp_buffer_size = get_buffer_size();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_buffer_size, tmp_buffer_size, this);
  // Resize vectors
  if (tmp_buffer_size != get_buffer_size())
  {
  }
  long tmp_simulation_steps = get_simulation_steps();
  nest::updateValueParam<long>(__d, nest::state_neuron_CV_names::_simulation_steps, tmp_simulation_steps, this);
  // Resize vectors
  if (tmp_simulation_steps != get_simulation_steps())
  {
  }
  long tmp_N_fbk = get_N_fbk();
  nest::updateValueParam<long>(__d, nest::state_neuron_CV_names::_N_fbk, tmp_N_fbk, this);
  // Resize vectors
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CV_names::_N_pred, tmp_N_pred, this);
  // Resize vectors
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CV_names::_fbk_bf_size, tmp_fbk_bf_size, this);
  // Resize vectors
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CV_names::_pred_bf_size, tmp_pred_bf_size, this);
  // Resize vectors
  ...
  double tmp_p = get_p();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_p, tmp_p, this);
  // Resize vectors
  if (tmp_p != get_p())
  {
  }
  double tmp_pred_offset = get_pred_offset();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_pred_offset, tmp_pred_offset, this);
  // Resize vectors
  if (tmp_pred_offset != get_pred_offset())
  {
  }
  double tmp_time_wait = get_time_wait();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_time_wait, tmp_time_wait, this);
  // Resize vectors
  if (tmp_time_wait != get_time_wait())
  {
  }
  double tmp_time_trial = get_time_trial();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_time_trial, tmp_time_trial, this);
  // Resize vectors
  ...
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_in_rate, tmp_in_rate, this);
  double tmp_out_rate = get_out_rate();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_out_rate, tmp_out_rate, this);
  long tmp_spike_count_out = get_spike_count_out();
  nest::updateValueParam<long>(__d, nest::state_neuron_CV_names::_spike_count_out, tmp_spike_count_out, this);
  std::vector< double >  tmp_current_fbk_input = get_current_fbk_input();
  updateValue<std::vector< double > >(__d, nest::state_neuron_CV_names::_current_fbk_input, tmp_current_fbk_input);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CV_names::_current_pred_input, tmp_current_pred_input);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CV_names::_fbk_buffer, tmp_fbk_buffer);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CV_names::_pred_buffer, tmp_pred_buffer);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CV_names::_fbk_counts, tmp_fbk_counts);
  ...
  updateValue<std::vector< double > >(__d, nest::state_neuron_CV_names::_pred_counts, tmp_pred_counts);
  ...
  nest::updateValueParam<long>(__d, nest::state_neuron_CV_names::_tick, tmp_tick, this);
  long tmp_position_count = get_position_count();
  nest::updateValueParam<long>(__d, nest::state_neuron_CV_names::_position_count, tmp_position_count, this);
  double tmp_mean_fbk = get_mean_fbk();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_mean_fbk, tmp_mean_fbk, this);
  double tmp_mean_pred = get_mean_pred();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_mean_pred, tmp_mean_pred, this);
  double tmp_var_fbk = get_var_fbk();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_var_fbk, tmp_var_fbk, this);
  double tmp_var_pred = get_var_pred();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_var_pred, tmp_var_pred, this);
  double tmp_CV_fbk = get_CV_fbk();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_CV_fbk, tmp_CV_fbk, this);
  double tmp_CV_pred = get_CV_pred();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_CV_pred, tmp_CV_pred, this);
  double tmp_w_fbk = get_w_fbk();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_w_fbk, tmp_w_fbk, this);
  double tmp_w_pred = get_w_pred();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_w_pred, tmp_w_pred, this);
  double tmp_total_CV = get_total_CV();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_total_CV, tmp_total_CV, this);
  double tmp_lambda_poisson = get_lambda_poisson();
  nest::updateValueParam<double>(__d, nest::state_neuron_CV_names::_lambda_poisson, tmp_lambda_poisson, this);
  ...
  set_p(tmp_p);
  set_pred_offset(tmp_pred_offset);
