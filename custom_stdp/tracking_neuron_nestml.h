...
inline void tracking_neuron_nestml::get_status(Dictionary &__d) const
{
  // parameters
  __d[ nest::tracking_neuron_nestml_names::_kp ] = get_kp();
  __d[ nest::tracking_neuron_nestml_names::_pos ] = get_pos();
  __d[ nest::tracking_neuron_nestml_names::_base_rate ] = get_base_rate();
  __d[ nest::tracking_neuron_nestml_names::_simulation_steps ] = get_simulation_steps();
  __d[ nest::tracking_neuron_nestml_names::_traj ] = get_traj();

  // initial values for state variables in ODE or kernel
  __d[ nest::tracking_neuron_nestml_names::_out_rate ] = get_out_rate();
  __d[ nest::tracking_neuron_nestml_names::_lambda ] = get_lambda();
  __d[ nest::tracking_neuron_nestml_names::_spike_count_out ] = get_spike_count_out();
  __d[ nest::tracking_neuron_nestml_names::_current_step ] = get_current_step();
  __d[ nest::tracking_neuron_nestml_names::_curr_traj ] = get_curr_traj();
...
inline void tracking_neuron_nestml::set_status(const Dictionary &__d)
{
  // parameters
  double tmp_kp = get_kp();
  nest::update_value_param<double>(__d, nest::tracking_neuron_nestml_names::_kp, tmp_kp, this);
  // Resize vectors
  if (tmp_kp != get_kp())
  {
  }
  bool tmp_pos = get_pos();
  nest::update_value_param<bool>(__d, nest::tracking_neuron_nestml_names::_pos, tmp_pos, this);
  // Resize vectors
  if (tmp_pos != get_pos())
  {
  }
  double tmp_base_rate = get_base_rate();
  nest::update_value_param<double>(__d, nest::tracking_neuron_nestml_names::_base_rate, tmp_base_rate, this);
  // Resize vectors
  if (tmp_base_rate != get_base_rate())
  {
  }
  long tmp_simulation_steps = get_simulation_steps();
  nest::update_value_param<long>(__d, nest::tracking_neuron_nestml_names::_simulation_steps, tmp_simulation_steps, this);
  // Resize vectors
  ...
  __d.update_value( nest::tracking_neuron_nestml_names::_traj, tmp_traj);
  // Resize vectors
  ...
  nest::update_value_param<double>(__d, nest::tracking_neuron_nestml_names::_out_rate, tmp_out_rate, this);
  double tmp_lambda = get_lambda();
  nest::update_value_param<double>(__d, nest::tracking_neuron_nestml_names::_lambda, tmp_lambda, this);
  long tmp_spike_count_out = get_spike_count_out();
  nest::update_value_param<long>(__d, nest::tracking_neuron_nestml_names::_spike_count_out, tmp_spike_count_out, this);
  long tmp_current_step = get_current_step();
  nest::update_value_param<long>(__d, nest::tracking_neuron_nestml_names::_current_step, tmp_current_step, this);
  double tmp_curr_traj = get_curr_traj();
  nest::update_value_param<double>(__d, nest::tracking_neuron_nestml_names::_curr_traj, tmp_curr_traj, this);
