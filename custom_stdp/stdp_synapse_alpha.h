...
template < typename targetidentifierT >
void
stdp_synapse_alpha< targetidentifierT >::get_status( Dictionary& d ) const
{
...
template < typename targetidentifierT >
void
stdp_synapse_alpha< targetidentifierT >::set_status( const Dictionary& d, ConnectorModel& cm )
{
